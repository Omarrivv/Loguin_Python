...
import sqlite3
#Nos permite conectarnos a una base de datos (sqlite3)
ventana=tk.Tk()  # iniciamos nuestra app , en la variable ventana tenemos todas las funciones de TK y poder trabajr con ello
ventana.title("Login CodeFxRoma Hack Prueba")	#Titulo de la ventana principal
...
imagen=Image.open("logoia.jpeg")						#Abrimos la imagen 'logo.png'
...
img_reg=Image.open("logoia.jpeg")						#Abrimos la imagen 'rak.jpg'
img_reg=img_reg.resize((100,220),Image.LANCZOS)	#Redimensionamos la imagen
